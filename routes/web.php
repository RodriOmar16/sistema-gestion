...
Route::middleware(['auth', 'verificarRuta'])->group(function () {
    ...
    Route::get('/productos-stock/habilitados', [ProductoController::class, 'productosStockHabilitados'])->name('productos.StockHabilitados');
    ...
    Route::get('/gastos/obtener-datos', [GastoController::class, 'getGatos'])->name('gastos.getGatos'); 
    Route::get('/gastos/obtener-categorias', [GastoController::class, 'getGatosCategorias'])->name('gastos.getGatosCategorias'); 
    ...
    Route::put('/caja/eliminar-index/{caja}', [CajaController::class, 'destroyIndex'])->name('caja.destroyIndex');
