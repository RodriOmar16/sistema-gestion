...
export default function DataTableGastos({ datos, openEdit, abrirConfirmar, totalFilas, current_page, last_page, next_page_url, prev_page_url }: Props) {
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        ...
        <div className="space-x-2">
          <Button
            ...
            size="sm"
            onClick={() => {
              router.get(route('gastos.index'), { page: current_page - 1 },{
                preserveState: true,
                preserveScroll: true,
              });
            }}
